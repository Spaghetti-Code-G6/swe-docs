...
Il pattern architetturale scelto è il \glossario{Model View Presenter}. 
...
dei dati per evitare istanze multiple del \glossario{Dataset}, della Distance Matrix e dei grafici una volta creati. Nel momento in cui 
