...
\begin{figure}[H]
	\centering
	\includegraphics[width=14cm]{img/media_gul.jpg}
...
Qui di seguito verranno presentati i resoconti relativi ai controlli di qualità effettuati nella fase di progettazione. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=14cm]{img/media_gul_RP.jpg}
...
\subsubsection{Risultati test fase di TODO}
Qui di seguito verranno presentati i resoconti relativi ai controlli di qualità effettuati nella fase di TODO. 
...
\subsubsection{Riepilogo esito dei test}
Nel seguente grafico, si possono vedere tutti i test che sono stati superati e tutti quelli che, invece, sono falliti.
...
\subsubsection{Riepilogo esito verifiche indici di Gulpease}
