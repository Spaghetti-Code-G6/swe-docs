...
\begin{center}
	\begin{longtable}{|l|c|c|c|c|c|c|c|}
		...
		\hline	
		\rowcolor{white}
		\caption{Suddivisione delle ore nella fase di Progettazione e codifica di dettaglio}
	\end{longtable}
\end{center}
...
\begin{center}
	\begin{longtable}{|l|c|c|}
		...
		\hline
		\rowcolor{white}
		\caption{Prospetto economico in riferimento al prospetto orario nella fase di Progettazione e codifica di dettaglio}
	\end{longtable}
\end{center}
