...
Di seguito vengono riportate le ore di lavoro effettivi durante la fase di progettazione e codifica di dettaglio: \\
...
Avendo risparmiato 41,00 € nella fase precedente, il bilancio del gruppo è in positivo di X €. Questo è dovuto a XXXXXXXXX. Le ore assegnate ai ruoli ti \textsc{amministratore} e \textsc{responsabile} sono ritenute eccessive, al contrario invece, sono necessarie più ore assegnate al ruolo di \textsc{programmatore}. A fronte di ciò abbiamo deciso di togliere alcune ore ai ruoli dell'\textsc{amministratore} e del \textsc{responsabile}, aggiungendone a quello del \textsc{programmatore}. 
...
\begin{center}
	\begin{longtable}{|l|c|c|c|c|c|c|c|}
		...
		\hline
			...
			\hline
			\textbf{Ore totali ruoli} & \textbf{7} & \textbf{4} & \textbf{2} & \textbf{25} & \textbf{25} & \textbf{77} & \textbf{140} \\
			\hline
		\rowcolor{white}
...
\begin{center}
	\begin{longtable}{|l|c|c|c|c|c|c|c|}
		...
		\hline
			Contro Daniel Eduardo & 9 & 6(-1) & 0 & 18 & 32(+1) & 35 & 100 \\
			Fichera Jacopo & 4(-5) & 2(-2) & 0 & 26(-1) & 31(+7) & 37(+1) & 100 \\
			Kostadinov Samuel & 10 & 0 & 9(+1) & 28(+2) & 17 & 336(-3) & 100 \\		
			Masevski Martin & 8(-3) & 0 & 5 & 18 & 26(+8) & 43(-5) & 100 \\
			Pagotto Manuel & 16(-2) & 2(-2) & 10(+1) & 15 & 18(+2) & 39(+1) & 100 \\			
			Paparazzo Giorgia & 0 & 6 & 9(-3) & 29(+4) & 21(+1) & 35(-2) & 100 \\
			Rizzo Stefano & 3(-5) & 17 & 2 & 18(+2) & 24(+6) & 36(-3) & 100 \\
			\hline
			\textbf{Ore totali ruolo} & \textbf{50(-15)} & \textbf{33(-5)} & \textbf{35(-1)} & \textbf{152(+7)} & \textbf{169(+25)} & \textbf{261(-11)} & \textbf{700} \\
		\hline	
		\rowcolor{white}
...
\begin{center}
	\begin{longtable}{|l|c|c|}
		...
		Responsabile & 50(-15) & 1.500,00(-450,00) \\
		Amministratore & 33(-5) & 660,00(-100,00) \\
		Analista & 35(-1) & 875,00(-25,00) \\
		Progettista & 152(+7) & 3.344,00(+154,00) \\
		Programmatore & 169(+25) & 2.535,00(+375,00) \\
		Verificatore & 261(-11) & 3.915,00(-165,00) \\
		\hline
		\textbf{Totale} & \textbf{700} & \textbf{12.829,00(-211,00)}\\
		\hline
		\rowcolor{white}
		\caption{Preventivo a finire progettazione e codifica di dettaglio - Prospetto dei costi delle ore rendicontate}
	\end{longtable}
\end{center}
Il carico di ore per persona è rimasto invariato, tuttavia togliendo alcune ore ai ruoli di \textsc{amministratore} e \textsc{responsabile} il preventivo è sceso di 211,00 €.\\
Il preventivo a finire è ora di 12.829,00 €. 
