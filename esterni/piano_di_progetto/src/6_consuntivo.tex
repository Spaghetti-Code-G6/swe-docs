...
\begin{itemize}
	\item Il gruppo ha necessitato di più ore di quante preventivate per la scrittura del codice, come tracciato nella sezione \S\ref{sub:rischi_rq} Codice RT01-002. %TODO Aggiornare questa sezione con i riferimenti all'appendice A - rischi riscontrati
\end{itemize}
