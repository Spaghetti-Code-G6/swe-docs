...
\begin{table}[!ht]
	...
	\textbf{Nome} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pg}  & \textbf{Pr}   & \textbf{Ve} & \textbf{Totale}\\
	\hline
	Contro Daniel Eduardo & 4 & 0 & 0 & 13(+3) & 20(+2) & 13 & 30 \\
	Fichera Jacopo & 0 & 0 & 0 & 17 & 17 & 16 & 30 \\
	Kostadinov Samuel & 4 & 0 & 0 & 10(+2) & 18(+3) & 18(+1) & 30 \\			
	Masevski Martin & 0 & 0 & 5 & 13 & 13 & 19 & 30 \\
	Pagotto Manuel & 3 & 0 & 0 & 11(+2) & 19(+3) & 17 & 30 \\			
	Paparazzo Giorgia & 0 & 6 & 2 & 17 & 10 & 15 & 30 \\
	Rizzo Stefano & 0 & 8 & 0 & 12 & 14 & 16 & 30 \\
	\hline
	\textbf{Ore totali ruolo} & \textbf{11} & \textbf{14} & \textbf{7} & \textbf{93(+7)} & \textbf{111(+8)} & \textbf{114(+1)} & \textbf{350} \\
	\hline
	\end{tabular}
...
\begin{center}
	\begin{longtable}{|l|c|c|c|c|c|c|c|}
		...
		\hline
			...
			Fichera Jacopo & 4 & 2(-2) & 0 & 0 & 5(+5) & 9(+2) & 20 \\ 
			...
			Rizzo Stefano & 3 & 0 & 2 & 0 & 5(+5) & 10 & 20 \\
			\hline
			\textbf{Ore totali ruoli} & \textbf{7} & \textbf{4(-4)} & \textbf{2} & \textbf{25} & \textbf{25(+12)} & \textbf{77(+2)} & \textbf{140} \\
			\hline
		\rowcolor{white}
...
\begin{center}
	\begin{longtable}{|l|c|c|c|c|c|c|c|}
		...
		\hline
			Contro Daniel Eduardo & 4 & 6(-1) & 0 & 21(+3) & 34(+3) & 35 & 100 \\
			Fichera Jacopo & 4 & 2(-2) & 0 & 26(-1) & 31(+7) & 37(+1) & 100 \\
			...
			Rizzo Stefano & 3 & 17 & 2 & 18(+2) & 24(+6) & 36(-3) & 100 \\
			\hline
			\textbf{Ore totali ruolo} & \textbf{34(-25)} & \textbf{33(-5)} & \textbf{35(-1)} & \textbf{159(+14)} & \textbf{177(+33)} & \textbf{262(-10)} & \textbf{700} \\
		\hline	
		\rowcolor{white}
