...
\begin{center}
	\begin{longtable}{|p{4cm}|p{6cm}|p{6cm}|}
		...
		& I responsabili si sono impegnati nell'applicare metodi più efficaci per la gestione delle risorse e delle scadenze per questa fase e sopratutto per la fase successiva. Ogni membro del gruppo si impegna a comunicare in modo più frequente e chiaro con il resto del team. \\
		\hline
		\rowcolor{white}
