...
\textbf{HD-Viz:}
\begin{itemize}
    \item \textbf{Individuazione dell'architettura:}
    \begin{itemize}
        \item \textbf{Incremento I:} Si individuano i pattern che più si adattano alle necessità e ai vari componenti dell'applicazione;
    \end{itemize}
    \item \textbf{Creazione diagrammi UML:}
    \begin{itemize}
        \item \textbf{Incremento I:} Si creano i diagrammi relativi alla parte X;
        \item \textbf{Incremento II:} Si creano i diagrammi relativi alla parte Y;
        \item \textbf{Incremento III:} Si creano i diagrammi relativi alla parte Z;
    \end{itemize}
    \item \textbf{Codifica:}
    \begin{itemize}
...
sono gli stessi della pianificazione precedente. Per quanto riguarda invece la codifica software si è dovuto rivalutare quanto lavoro svolgere. \\

\textbf{HD-Viz:}
\begin{itemize}
    \item \textbf{Correzione dell'architettura:}
    \begin{itemize}
        \item \textbf{Incremento I:} Si correggono i pattern relativi a X;
        \item \textbf{Incremento II:} Si correggono i pattern relativi a Y;
    \end{itemize}
    \item \textbf{Codifica:}
    \begin{itemize}
        \item \textbf{Incremento I:} Si codifica la parte X e se ne realizzano i test;
...
%aggiornati i documenti e verrà verificato il software creato. Saranno impiegati principalmente verificatori e programmatori al fine di effettuare un controllo serrato sul software che verrà rilasciato. Sarà completato il \textsc{Manuale d'utente} e sarà redatta la presentazione e la lettera finale. 
%Nella settimana successiva alla consegna della \textsc{Revisione di Accettazione} verrà redatta la presentazione da portare in sede di revisione programmata giorno 10/05/2021.
