...
\item \textbf{Codifa del Proof of Concept};
...
Periodo: dal 19/01/2021 al 11/02/2021
Questa fase inizia subito dopo la presentazione della Revisione dei Requisiti e finisce con l'inizio del primo primo incremento.
Vengono individuate soluzioni architetturali per cui i requisiti richiesti vengano soddisfatti.

\subsubsection{Attività}
\begin{itemize}
    \item \textbf{Revisione e verifica}: revisione e/o aggiunta e verifica di tutti i documenti \emph{v1.0.0} prodotti fino ad ora.
    \item \textbf{Ricerca tecnologie}: scelta di strumenti e tecnologie usate nella sucessiva fase di codifica del \glossario{Proof of Concept} previo studio autonomo;
...
Periodo: dal 11/02/2021 al 29/02/2021. \\
In questo periodo vengono scelti alcuni dei requisiti più rilevanti individuati durante la fase di Analisi.
I requsiti sono stati concordati con il proponente \textsc{Zucchetti S.p.A}, come dichiarato nel verbale []%TODO INSERIRE VERBALE CALL CON ZUCCHETTI
