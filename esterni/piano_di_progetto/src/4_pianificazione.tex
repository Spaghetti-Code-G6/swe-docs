...
\paragraph{Attività}
\begin{itemize}
    \item Installazione e configurazione ambiente Node.
\end{itemize}

\subsubsection{II incremento}
\paragraph{Attività}
\begin{itemize}
    \item Codifica del front-end dell'applicazione \emph{HD Viz}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Implementazione del parser CSV e dell'assegnazione delle label in automatico.
\end{itemize}
