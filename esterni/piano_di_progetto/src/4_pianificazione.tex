...
Periodo: dal 2021-03-10 al 2021-06-21.\\ \\
...
\begin{itemize}
    ...
    \item \textbf{Milestone 2:}
        ...
        \item \textbf{Incremento V:} Sviluppo modifica visualizzazione;
	\end{itemize}
    \item \textbf{Milestone 3:}
        \begin{itemize}
        \item \textbf{Incremento VI:} Sviluppo visualizzazione errori;
        \item \textbf{Incremento VII:} Sviluppo modifiche Distance Map;
        \item \textbf{Incremento VIII:} Sviluppo inserimento dati tramite database;
        \item \textbf{Incremento IX:} Estensione ScatterPlot Matrix;
    \end{itemize}
    \item \textbf{Milestone 4:}
        ...
        \item \textbf{Incremento XII:} Sviluppo Force Filed;
    \end{itemize}
