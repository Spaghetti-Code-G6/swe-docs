...
\begin{itemize}
	...
	\item \textbf{Interfacce:} essendo JavaScript \glossario{duck typed} si assume che le interfacce siano dei contratti che devono essere rispettati dagli oggetti.\\
