...
\begin{itemize}
	...
	\item \textbf{Intestazione funzioni:} \\
		ciascuna funzione e/o memtodo dev'essere preceduta dalla seguente intestazione specificando opportunamente i valori
		\begin{lstlisting}[style=htmlcssjs]
			/**
...
\begin{itemize}
	...
	\item \textbf{Id e classi}:\\
		i valori degli id e delle classi devono privilegiare l'espressività e seguire la convenzione \glossario{hyphen-case}
		\begin{lstlisting}[style=html]
