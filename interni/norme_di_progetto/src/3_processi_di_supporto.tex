...
I test sono codice e come tale, dovranno essere scritti in modo da soddifare i requisiti di qualità richiesti.
Fondamentale per fare chiarezza ed aumentare la manutenibilità del codice è la presenza di commenti che vadano a
documentarne il comportamento. Ogni metodo di test potrà essere preceduto, se ritenuto necessario per aumentare le
chiarezza, da un commento che ne descrive sinteticamente il funzionamento, i parametri ed i risultati aspettati.
Potranno inoltre, essere aggiunti commenti all'interno del codice che descrivono il comportamento delle singole
istruzioni se ritenuto opportuno.\\
