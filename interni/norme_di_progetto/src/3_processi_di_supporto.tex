...
metriche scelte. \\
Per poter realizzare le seguenti attività il gruppo si baserà sugli \emph{standard ISO-12207}.\\

%Le attività aggregate dal processo in questione sono le seguenti:
%\begin{itemize}
